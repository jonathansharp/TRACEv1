function [DATA,HEADERS,NICEHEADERS]=CO2SYSFragaImpatient(PAR1,PAR2,PAR1TYPE,PAR2TYPE,SAL,TEMPIN,TEMPOUT,PRESIN,PRESOUT,SI,PO4,pHSCALEIN,K1K2CONSTANTS,KSO4CONSTANTS);
%**************************************************************************
%
...
pHTol       = 0.001;  % tolerance for iterations end
ln10        = log(10); %
